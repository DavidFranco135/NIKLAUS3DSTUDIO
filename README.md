...
> **Status atual: FASE 7 — CAD paramétrico (motor real).** `PARAMETRIC_CAD` deixou de ser mock: `Build123DCADProvider` gera geometria de verdade (build123d/OCCT — furo por boolean subtraction, texto embossado, cantos arredondados, containers ocos), sem GPU, sem subprocess, testado ao vivo (o exemplo do chaveiro 70x35x4mm com furo e nome do ARCHITECTURE.md funciona de ponta a ponta). Text-to-3D e Image-to-3D continuam mock (Fases 4-6) — CAD paramétrico é geometria determinística, não depende de modelo de IA generativo nem de GPU, por isso pôde avançar primeiro. Ver [docs/AI.md](docs/AI.md) e [docs/AI-LICENSES.md](docs/AI-LICENSES.md).
>
